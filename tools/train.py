...
from skeletonagent import __version__
from skeletonagent.apis import init_random_seed, train_model
from skeletonagent.datasets import build_dataset
from skeletonagent.models import build_model
from skeletonagent.utils import collect_env, get_root_logger, mc_off, mc_on, test_port
...
def main():
    ...
    if cfg.checkpoint_config is not None:
        # save skeletonagent version, config file content and class names in
        # checkpoints as meta data
        cfg.checkpoint_config.meta = dict(
            skeletonagent_version=__version__ + get_git_hash(digits=7),
