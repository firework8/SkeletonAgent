modality = 'km'
graph = 'uav'
work_dir = f'./work_dirs/uav_csv1/km'
...
model = dict(
    ...
    cls_head=dict(
        type='SimpleHead', joint_cfg=graph, num_classes=155, in_channels=384, work_dir=work_dir, interval_epoch=5, weight_1=0.05, weight_2=0.2))
