...
model = dict(
    ...
    backbone=dict(
        type='GCN_Module_LLM',
        llm_model='gpt4o', llm_modality = modality, num_classes=60,
        tcn_ms_cfg=[(3, 1), (3, 2), (3, 3), (3, 4), ('max', 3), '1x1'],
        graph_cfg=dict(layout=graph, mode='random', num_filter=8, init_off=.04, init_std=.02)),
    cls_head=dict(
        type='SimpleHead', joint_cfg=graph, num_classes=60, in_channels=384, work_dir=work_dir, interval_epoch=5, weight_1=0.2, weight_2=0.5))
...
#         graph_cfg=dict(layout=graph, mode='random', num_filter=8, init_off=.04, init_std=.02)),
#     cls_head=dict(
#         type='SimpleHead_Semi', joint_cfg=graph, num_classes=60, in_channels=384, work_dir=work_dir, interval_epoch=5, weight_1=0.2, weight_2=0.5))
