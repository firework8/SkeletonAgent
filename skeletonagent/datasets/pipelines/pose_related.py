...
class JointToBone:
    ...
    def __init__(self, dataset='nturgb+d', target='keypoint'):
        self.dataset = dataset
        self.target = target
        if self.dataset not in ['nturgb+d', 'openpose', 'openpose_new', 'coco', 'coco_new', 'uav']:
            raise ValueError(
        ...
        if self.dataset == 'nturgb+d':
            ...
            self.pairs = ((0, 0), (1, 1), (2, 1), (3, 2), (4, 1), (5, 4), (6, 5), (7, 1), (8, 7), (9, 8), (10, 7),
...
class JointToKB:
    ...
    def __init__(self, dataset='nturgb+d', target='keypoint'):
        ...
        if self.dataset == 'nturgb+d':
            ...
            self.pairs = ((0, 0), (1, 1), (2, 2), (3, 1), (4, 4), (5, 1), (6, 4), (7, 7), (8, 1), (9, 7), (10, 1),
